...
use crate as pallet_life_learning_passport;
use frame_support::traits::{ConstU16, ConstU64};
use sp_core::H256;
use sp_runtime::{
	traits::{BlakeTwo256, IdentityLookup}, testing::Header, BuildStorage,
};
...
frame_support::construct_runtime!(
	...
	{
		System: frame_system,
		LifeLearningPassport: pallet_life_learning_passport,
	}
);
