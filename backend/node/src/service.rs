...
use keiko_runtime::{opaque::Block, RuntimeApi};

// Our native executor instance.
pub struct KeikoRuntimeExecutor;

impl sc_executor::NativeExecutionDispatch for KeikoRuntimeExecutor {
...
type ParachainExecutor = NativeElseWasmExecutor<KeikoRuntimeExecutor>;
...
/// Build the consensus-related parts of the runtime.
fn build_consensus(
	client: Arc<ParachainClient>,
	block_import: ParachainBlockImport,
	...
	let params = BuildAuraConsensusParams {
		...
		slot_duration,
		relay_chain_slot_duration,
		proposer: SlotProportion::new(2f32 / 3f32),
		max_block_size: None,
